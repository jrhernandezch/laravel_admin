            ...
            <div class="card-body">
              <div class="row">
                <div class="col-12 text-right">
                  <a class="btn btn-app" id="new-service">
                    <i class="fas fa-plus" title="Crear nou servei"></i> Nou
                  </a>
                </div>
              </div>
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header bg-olive">
          <h4 class="modal-title">Serveis</h4>
          ...
          <div class="row">
            <div class="col-12">
              <div class="form-group">
                <label for="inputName">Nom servei</label>
                <input type="text" class="form-control" id="inputName" placeholder="Nom del servei">
              </div>
            </div>
            <div class="col-6"></div>
            <div class="col-12">
            ...
            <div class="col-12">
              ...
              <form action="{{ route('image.upload.post', ['dir' => 'services']) }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                  <div class="col-md-6">
